...
|---|---|---|
| Game outcome | Logistic regression on season-to-date form differentials: win%, net rating, four factors, pace, ORtg/DRtg, rest, back-to-backs + home court | 68% accuracy (55% baseline: always pick home) |
